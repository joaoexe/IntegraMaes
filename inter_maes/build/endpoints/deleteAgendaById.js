...
exports.deleteAgendaById = void 0;
const connection_1 = __importDefault(require("../connection"));
const deleteAgendaById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        if (!id) {
...
exports.deleteAgendaById = deleteAgendaById;
//# sourceMappingURL=deleteAgendaById.js.map